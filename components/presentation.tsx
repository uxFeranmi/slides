...
import { ComponentLogic, useLogic } from "@cleanweb/react";
...
class Presentation extends ComponentLogic<TProps, TState, {i: true}> {
...
const RC = (props: TProps) => {
	const self = useLogic(Presentation, props);

	const { children = null, slides, RootTag = 'main' } = self.props;
	const { slideIndex } = self.state;
